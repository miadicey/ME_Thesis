...
#define I2C_TIMEOUT 1000	//Defines how long to wait for the I2C before moving forward. Prevents code from stopping infinitely for faulty bus.

// Defining registers for the values of these to sit in?
#define ZPOSL 0x01
#define ZPOSR 0x02
#define MPOSL 0x03
#define MPOSR 0x04
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if((HAL_GetTick() - last_req) > req_period) {
      last_req = HAL_GetTick();
